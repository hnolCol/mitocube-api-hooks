...
export function createCoreMaintenanceEventsAPI(client) {
    ...
    */
    async function getMaintenanceEventsByTag_API({ tag }) {
        const res = await client.get(`/maintenance/${tag}`)
        return res.data 
    }

    const useGetMaintenanceEventByTag = (APIParams = { tag }, useQueryOptions = {stateTime : 200000}) => {
        return useQuery({
    ...
    async function postMaintenanceEventState_API({ maintenance_event_tag, event_state_tag }) {
        const res = await client.post(`/maintenance/${maintenance_event_tag}/state/${event_state_tag}`,
        )
        return res.data 
    }
    const usePostMaintenanceEventState = (useMutationOptions = {}) => {
        return useMutation({
    ...
    async function getMaintenanceEventState_API({ maintenance_event_tag }) {
        const res = await client.get(`/maintenance/${maintenance_event_tag}/state`)
        return res.data
    }   

    const useGetMaintenanceEventState = (APIParams = { maintenance_event_tag }, useQueryOptions = {stateTime : 2000, placeholderData : prev => prev}) => {
        return useQuery({
    ...
    */
    async function getMaintenanceEventsByQuery_API({ instrument_tag, timestamp_min, timestamp_max, user_tag, limit }) {
        const res = await client.get(`/maintenance/q`, { params: {instrument_tag, timestamp_min, timestamp_max, user_tag, limit} })
        return res.data 
    }

    const useGetQueryMaintenanceEvents = (APIParams = {instrument_tag, timestamp_min, timestamp_max, user_tag, limit}, useQueryOptions = {stateTime : 200000, placeholderData: (prev) => prev}) => {
        return useQuery({
    ...
    */
    async function getMaintenanceEventsCount_API({ instrument_tag, timestamp_min, timestamp_max, user_tag  }) {
        const res = await client.get(`/maintenance/count`, { params: {instrument_tag, timestamp_min, timestamp_max, user_tag } })
        return res.data 
    }

    const useGetMaintenanceEventCount = (APIParams = {instrument_tag, timestamp_min, timestamp_max, user_tag}, useQueryOptions = {stateTime : 200000, placeholderData: (prev) => prev}) => {
        return useQuery({
            queryKey: ["getMaintenanceEventsQuery",
                APIParams.instrument_tag,
                APIParams.timestamp_max,
    ...
    async function getMaintenanceCosts_API({ instrument_tag, timestamp_min, timestamp_max }) {
        const res = await client.get(`/maintenance/instruments/${instrument_tag}/costs`, { params: {timestamp_min, timestamp_max} })
        return res.data 
    }

    const useGetMaintenanceCosts = (APIParams = {instrument_tag, timestamp_min, timestamp_max}, useQueryOptions = {stateTime : 200000}) => {
        return useQuery({
    ...
    const usePostMaintenanceEvent = (useMutationOptions = {}) => {
        return useMutation({
    ...
    async function postMaintenanceProcedureToMaintenanceEvent_API({ maintenance_event_tag, procedure_tag }) {
        const res = await client.post(`/maintenance/${maintenance_event_tag}/procedures/${procedure_tag}`,
        )
        return res.data 
    }   


    const usePostMaintenanceProcedureToMaintenanceEvent = (useMutationOptions = {}) => {
        return useMutation({
    ...
    async function postSparePartToMaintenanceEvent_API({ maintenance_event_tag, sparepart_tag }) {
        const res = await client.post(`/maintenance/${maintenance_event_tag}/spareparts/${sparepart_tag}`,
        )
        return res.data 
    }   


    const usePostSparePartToMaintenanceEvent = (useMutationOptions = {}) => {
        return useMutation({
    ...
    async function getSparePartCountByMaintenanceEvent_API({ maintenance_event_tag, sparepart_tag }) {
        const res = await client.get(`/maintenance/${maintenance_event_tag}/spareparts/${sparepart_tag}/count`)
        return res.data
    }   


    const useGetSparePartCountByMaintenanceEvent = (APIParams = { maintenance_event_tag, sparepart_tag }, useQueryOptions = { placeholderData : prev => prev }) => {
        return useQuery({
    ...
    async function deleteSparePartToMaintenanceEvent_API({ maintenance_event_tag, sparepart_tag }) {
        const res = await client.delete(`/maintenance/${maintenance_event_tag}/spareparts/${sparepart_tag}`,
        )
        return res.data 
    }   


    const useDeleteSparePartToMaintenanceEvent = (useMutationOptions = {}) => {
        return useMutation({
    ...
    async function deleteProcedureOfMaintenanceEvent_API({ maintenance_event_tag, procedure_tag}) {
        const res = await client.delete(`/maintenance/${maintenance_event_tag}/procedures/${procedure_tag}`,
        )
        return res.data 
    }

    const useDeleteMaintenanceProcedureToMaintenanceEvent = (useMutationOptions = {}) => {
        return useMutation({
    ...
    async function postSymptomToMaintenanceEvent_API({ maintenance_event_tag, symptom_tag }) {
        const res = await client.post(`/maintenance/${maintenance_event_tag}/symptoms/${symptom_tag}`,
        )
        return res.data 
    }

    const usePostSymptomToMaintenanceEvent = (useMutationOptions = {}) => {
        return useMutation({
    ...
    async function deleteSymptomToMaintenanceEvent_API({ maintenance_event_tag, symptom_tag }) {
        const res = await client.delete(`/maintenance/${maintenance_event_tag}/symptoms/${symptom_tag}`,
        )
        return res.data 
    }

    const useDeleteSymptomToMaintenanceEvent = (useMutationOptions = {}) => {
        return useMutation({
    ...
    async function getMaintenanceEventCosts_API({ maintenance_event_tag }) {
        const res = await client.get(`/maintenance/${maintenance_event_tag}/costs`)
        return res.data 
    }

    const useGetMaintenanceEventCosts = (APIParams = { maintenance_event_tag }, useQueryOptions = { placeholderData : prev => prev }) => {
        return useQuery({
    ...
    async function postExternalServiceToMaintenanceEvent_API({ maintenance_event_tag, external_service_tag }) {
        const res = await client.post(`/maintenance/${maintenance_event_tag}/externalservice/${external_service_tag}`,
        )
        return res.data 
    }

    const usePostExternalServiceToMaintenanceEvent = (useMutationOptions = {}) => {
        return useMutation({
    ...
    async function deleteExternalServiceFromMaintenanceEvent_API({ maintenance_event_tag, external_service_tag }) {
        const res = await client.delete(`/maintenance/${maintenance_event_tag}/externalservice/${external_service_tag}`,
        )
        return res.data 
    }

    const useDeleteExternalServiceFromMaintenanceEvent = (useMutationOptions = {}) => {
        return useMutation({
